...
namespace Shift.Services.Api.Controllers.Cadastro
{
    public class EmpresaController : BaseController
    {
        ...
        [HttpPost]
        [Route("v1/empresas")]
        [Authorize(Policy = "AdministracaoGravar")]
        // [AllowAnonymous]
        ...
        [HttpGet]
        [Route("v1/empresas")]
        [Authorize(Policy = "AdministracaoLer")]
        //[ResponseCache(Duration = 60)]
        public IEnumerable<EmpresaCommandResult> Listar([FromServices]IMemoryCache cache)
        {

            IEnumerable<EmpresaCommandResult> dadosJSON = cache.GetOrCreate<IEnumerable<EmpresaCommandResult>>("", context =>
            {
        ...
        [Authorize(Policy = "AdministracaoLer")]
        public EmpresaCommandResult ObterPorCodigo([FromServices]IMemoryCache cache, string codigo)
        {
