    ...
    public static class MvcConfiguration
    {
        ...
        public static void AddMvcSecurity(this IServiceCollection services, IConfigurationRoot configuration)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("AdministracaoLer",         policy => policy.RequireClaim("Usuario", "Ler"));
                options.AddPolicy("AdministracaoGravar",      policy => policy.RequireClaim("Usuario", "Gravar"));
       
                options.AddPolicy("AdministracaoLer",         policy => policy.RequireClaim("Empresa", "Ler"));
                options.AddPolicy("AdministracaoGravar",      policy => policy.RequireClaim("Empresa", "Gravar"));
