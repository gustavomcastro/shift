...
namespace Shift.Domain.Cadastro.CadastrosContabeis.CentroCustoModel.Handlers
{
        ...
        IHandler<ExcluirCentroCustoCommand>
    {
        ...
        public CentroCustoHandler(  IUser user, ICentroCustoRepository centroCustoRepository, IEmpresaRepository empresaRepository, 
                                    IGrupoRepository grupoRepository, IClasseContabilRepository classeContabilRepository, ITipoBloqueioRepository tipoBloqueioRepository, 
