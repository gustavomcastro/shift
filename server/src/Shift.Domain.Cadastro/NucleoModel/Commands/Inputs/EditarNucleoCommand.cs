...
{
    public class EditarNucleoCommand : BaseNucleoCommand, ICommandResult
    {

        public EditarNucleoCommand(Guid id, string codEmpresa, string nomeNucleo, string codGrupo)
        {
